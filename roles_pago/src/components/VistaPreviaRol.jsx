  ...
  return (
    <div className="card">
      <div className="card-body">
        <h5 className="card-title">COMPROBANTE DE PAGO DEL MES DE {empleado.mes.toUpperCase()} {empleado.anio}</h5>
